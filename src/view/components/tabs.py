...
def getTabs():
    return dcc.Tabs(id='bpmn-tabs', value='tab-bpmn', children=[
		get_BPMN_CPI_tab(),
		get_Strategy_tab(),
    ])
...
def get_BPMN_CPI_tab():
	return dcc.Tab(label='BPMN + CPI', value='tab-bpmn', style={'width': '50%', 'textAlign': 'center'}, children=[
		html.Div([
...
def get_Strategy_tab():
	return dcc.Tab(label='Define Strategy', value='tab-strategy', style={'width': '50%', 'textAlign': 'center'}, children=[
		html.Div([
