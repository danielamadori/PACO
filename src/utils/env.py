...
RELATIVE_PATH_ASSETS = 'assets/'
PATH_ASSETS = 'src/' + RELATIVE_PATH_ASSETS

BPMN_FOLDER = 'bpmnSvg/'
PATH_IMAGE_BPMN_FOLDER = PATH_ASSETS + BPMN_FOLDER
RELATIVE_PATH_IMAGE_BPMN_FOLDER = RELATIVE_PATH_ASSETS + BPMN_FOLDER

PATH_IMAGE_BPMN_LARK = PATH_ASSETS + 'bpmn.png'
RELATIVE_PATH_IMAGE_BPMN_LARK = RELATIVE_PATH_ASSETS + 'bpmn.png'
PATH_IMAGE_BPMN_LARK_SVG = PATH_ASSETS + 'bpmn.svg'
RELATIVE_PATH_IMAGE_BPMN_LARK_SVG = RELATIVE_PATH_ASSETS + 'bpmn.svg'

PATH_PARSE_TREE = PATH_ASSETS + 'parse_tree.png'
PATH_PARSE_TREE_SVG = PATH_ASSETS + 'parse_tree.svg'
